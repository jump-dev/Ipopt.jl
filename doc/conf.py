...
project = u'Ipopt.jl -- Julia interface for the Ipopt solver'
...
latex_documents = [
  ('ipopt', 'Ipopt.jl.tex', u'Ipopt.jl Documentation',
   AUTHORS, 'manual'),
]
...
man_pages = [
    ('ipopt', 'Ipopt', u'Ipopt.jl Documentation',
     [AUTHORS], 1)
]
...
texinfo_documents = [
  ('ipopt', 'Ipopt', u'Ipopt.jl Documentation',
   AUTHORS, 'Ipopt', 'Ipopt.jl - Julia interface to the Ipopt solver',
   'Miscellaneous'),
]
